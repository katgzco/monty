<h1 class="gap">0x19. C - Stacks, Queues - LIFO, FIFO</h1><div class="gap" id="project-description">
<p><img src="https://pbs.twimg.com/media/CFYYWy6UEAE9Ow-.png"/><br/>
<br/></p>
<h2>Resources</h2>
<p><strong>Read or watch</strong>:</p>
<ul>
<li><a href="/rltoken/56-bDz7IrFgcH02EkGkB3w" target="_blank" title="Google">Google</a> </li>
<li><a href="/rltoken/9neX6gaN6DoA-ow1INgZqw" target="_blank" title="How do I use extern to share variables between source files in C?">How do I use extern to share variables between source files in C?</a> </li>
</ul>
<h2>Learning Objectives</h2>
<p>At the end of this project, you are expected to be able to <a href="/rltoken/HEHmqu4ad0ZM63sqGlT2sQ" target="_blank" title="explain to anyone">explain to anyone</a>, <strong>without the help of Google</strong>:</p>
<h3>General</h3>
<ul>
...
<p>Please use the following data structures for this project. Don’t forget to include them in your header file.</p>
<pre><code>/**
...
<ul>
<li><a href="/rltoken/9RfVU4j7qVbFgGdMkpX2qA" target="_blank" title="Here is a link to a GitHub repository">Here is a link to a GitHub repository</a> that could help you making sure your errors are printed on <code>stderr</code></li>
</ul></li>
</ul>
<h3>Tests</h3>
